...
<td width="50px" align ="center"><div style'"display: table; margin-top: 50px; margin-right: 50px;"><br/><a href="../pages/logout.php">Logout</a></td>
</tr></table>
...
<!-- ============ Page Heading ============== -->
<p align="center" class="Dept">DEPARTMENT OF JUSTICE</p>
<p align="center" class="File">File No : X 23-17-08</p>
...
<a href="../pages/leaderboard.php" title="Check your standings" >LEADERBOARD</a><br><br><br>
<?php
include("connect.php");
