...
$result = mysql_query($query) or die(mysql_error());
  ...
  while($row = mysql_fetch_array($result)){
    ...
    if ($queryString == $row["activationkey"]){
       ...
       $content="You have been successfully registered.<br>Click <a href=../pages/index.php> here </a> to login.";
		include("layout.php");
