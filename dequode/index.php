...
<p class="button"><a href="../deqoude/instructions.php" target="_blank">RULES</a></p>
...
<!-- ============ Page Heading ============== -->
<h1 class="HeadingStyle">DEQUODE V2</h1>

<!-- ============ Begin Content ============== -->

<p class="Matter">Launching 1 October 2010 9 PM</p>
